...
namespace Test1
{
    public partial class UpdateDeleteByAdmin : System.Web.UI.Page
    {
        product product = new product();
            ...
            protected void Page_Load(object sender, EventArgs e)
            {
                ...
                {
                    Label1.Text = "Welcome! " + Session["UserAdminId"].ToString();
                }
                else
                {
                    Label1.Text = "";
                ...
                try
                {
                    ...
                    if (e.CommandName.Equals("AddNew"))
                    {
                        ...
                        using (SqlConnection con = new SqlConnection(CS)) //we use using to close the connection explicitly
                        {
                            ...
                            //string product_name = (row.FindControl("txtProductName") as TextBox).Text;
