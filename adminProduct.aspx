<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminProduct.aspx.cs" Inherits="Test1.adminProduct" %>
...
<body>
    ...
    <div class="container">
        <div class=" row">
            ...
            <div class="nav flex-column col-lg-6 " style="  position:absolute; z-index: 1;top: 75px;left:0px;height: 100%; width: 160px;  background-color: #111; overflow-x: hidden;">

                <div class="container">                    
                    <div class=" btn-group-lg" style="margin-top:50px;">
                            <table class="table-condensed">
                            <tr><td><a href="/Admin/Employeeslist" role="button">Products</a></td> </tr>
